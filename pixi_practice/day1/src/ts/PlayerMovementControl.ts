...
export class PlayerMovementControl{
     ...
     */
    constructor(public app:Application, private player:PIXI.Sprite, private mapRect:PIXI.Rectangle, keys:string[] = ["W","D","S","A"], private demoKeys:PIXI.Sprite){
